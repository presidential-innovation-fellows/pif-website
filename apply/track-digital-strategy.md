...
2. Advising organizations on developing and delivering digital products or services, contributing to the development or the evolution of the organization’s technical strategy, and leading technical teams (i.e. providing mentorship, reviewing code and overall architecture and making technical recommendations). This experience must include **ALL** of the following:
- Experience navigating highly ambiguous or uncertain situations to deliver results for clients / key stakeholders. 
- Leading cross functional teams in a commercial enterprise 
- Collaborating with cross-functional teams to achieve organizational or project objectives
- Obtaining buy-in from key stakeholders and multidisciplinary teams and leadership to effect change

3. Experience scaling strategic technical projects or programs; digital marketing or advertising; venture capital, accelerators, or incubators; and/or corporate innovation. This experience must include at least **THREE** of the following:
- Leading client-facing digital consulting projects or initiatives
- Determining a clear business model and lead development of company or commercial brand or product vision
- Constructing relevant minimum viable products (MVPs) or prototypes to test and address opportunity from multiple angles
- Developing a comprehensive growth strategy (e.g. driving growth through traditional & social media channels, referral programs, branding, and by designing network effects) 
- Defining go-to-market strategy and product roadmaps
- Conducting consumer insights research for the purpose of finding product market fit
- Creating business model based off calculated growth-related metrics
- Delivering against a P&L in a commercial enterprise
- Architecting complex platforms and developing enterprise-level technology roadmaps
- Designing, implementing, and optimizing processes for development, QA, security, and IT
- Identifying cybersecurity threats and actions required to mitigate risks
- Building or leading commercial accelerators, developing investment strategies, executing venture capital deals or managing investment portfolios to drive meaningful innovation
- Leading digital health or biotechnology efforts to improve medical outcomes and enhance efficiency  (e.g. health data interoperability, clinical decision support, care coordination, bio cybersecurity, etc.)
